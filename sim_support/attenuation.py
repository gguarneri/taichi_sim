...
class AttenuationCoefficients:
    ...
    def __init__(self):
        ...
        self._kappa_coeffs = (
            ...
            np.array([0.022560146386368083, 0.0045084712797122525, 0.00089378764037688395], dtype=np.float32)
        )

        self._non_kappa_coeffs = (
            np.array([0.024305444805272164, 0.0047281078292263955, 0.00096672526958635019], dtype=np.float32),
            np.array([0.022509197794294895, 0.0045013880073380965, 0.00089173320953691182], dtype=np.float32)
        )
