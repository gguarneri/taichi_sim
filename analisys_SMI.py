...
def plot_barplot_mean_max(data_list, labels, ylabel, output_file):
    ...
    ax.bar(x, means, alpha=0.8, label="Média")
    ax.scatter(x, maxs, color="red", marker="^", s=100, label="Máximo")
